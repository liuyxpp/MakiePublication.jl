...
#> [frontmatter]
#> Author = "Yi-Xin Liu"
#> title = "MakiePublication Tutorial"
#> date = "2022-10-17"
#> tags = ["tutorial", " Makie.jl", "Julia", "Publication", "Julia Package", "Plot"]
#> description = "A tutorial for MakiePublication, a Julia package for creating publication quality figures with Makie.jl"
...
To run this tutorial Pluto notebook, make sure you MakiePublication version is v0.3.1+. The recommended way is to use Pluto built-in package manager.
"""
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "4c7937ce7da5e1ebe68e8e69397e639ffc5ff423"
